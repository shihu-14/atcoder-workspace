...
using DP = tuple<int, vector<int>, vector<int>, vector<int>>; // T, 開けた箱, h, c
int n;
vector<int> H, C;
vector<vector<int>> a;
const int BW = 50;
...
{
    vector<pii> res;
    priority_queue<pii> pq; //攻撃力のmax, そのbuki名 
    for (auto w: buki)
    {

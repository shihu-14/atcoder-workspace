...
tuple<int, int, int, int, int, int, int> decide_next_station(vector<vector<int>> &board, vector<pii> &stations, vector<vector<int>> &earnlist, int turn, int T, int now_per_earn, int now_money){
    int n = board.size();
    int max_diff = 0;
...
tuple<int, int, int> two_station(vector<vector<int>> &board, vector<T3> &ans, vector<pii> &stations, vector<vector<int>> &earnlist, int K, int T){
    int n = board.size();

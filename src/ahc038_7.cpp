...
int main(){
    ...
    int times = 0;
    while(!tree.isfinish() && times <= 1000000){
        // cout << "!1" << endl;
        while(!tree.toput(V-1) && !tree.res_stk.empty() && times <= 1000000){
            ...
            while((tx < 0 || tx >= n || ty < 0 || ty >= n ) && times <= 1000000){
                // cout << "!2" << endl;
                tree.move(4);
                tree.rotate(1);
                tree.pull();
            ...
            while((nx != tree.tree[qr].x || ny != tree.tree[qr].y ) && times <= 1000000){
                // cout << "!3" << endl;
        ...
        // cout << "!4" << endl;
        while(!tree.topull() && !tree.pulling_stk.empty() && times <= 1000000){
            ...
            while((nx != tree.tree[i].x || ny != tree.tree[i].y ) && times <= 1000000){
                // cout << "!7" << endl;

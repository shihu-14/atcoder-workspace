...
-メモ
    ...
    2, 37, 35
    多い 48 54 62 15 47 57 60 92 94 75 93 5 14 16 19 26 29 32 44 99 3 20
     24 30 40 52 55 58 64 71 73 74 79 82 90 97 98
...
vector<vector<int>> a_r = {{20, 60, 0, 0, 0, 20}, {20, 20, 0, 30, 0, 30}, 
    {30, 0, 0, 30, 0, 40}, {0, 15, 0, 30, 0, 55}};
...
double t_sg = 10; // スタートからゴールまでの距離を評価する
...
vector<pii> alignment()
{
    ...
    while(1)
    {
        ...
        else if (op_kind == 2 || op_kind == 3 || op_kind == 4)
        {
            for (auto [x, y]: tmp_del)
            {
                g[x][y] = 'T';
